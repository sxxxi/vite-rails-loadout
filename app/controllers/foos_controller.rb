class FoosController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @foo.update(foo_params)
        format.html { redirect_to @foo, notice: "Foo was successfully updated.", status: :see_other }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to foos_path, notice: "Foo was successfully destroyed.", status: :see_other }
